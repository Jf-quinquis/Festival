...
public class Favoris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bdd = new Bdd(this);
        bdd.open();
        ArrayList<ModeleArtiste> listeModeleArtistes = bdd.getListeFavoris();
        bdd.close();

        if (listeModeleArtistes != null){
            RecyclerView recyclerView = findViewById(R.id.recycleViewFavoris);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));
            recyclerView.setAdapter(new FavorisViewAdapter(getApplicationContext(), listeModeleArtistes));
        }
    }
